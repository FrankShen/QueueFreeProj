...
- (void)viewDidLoad
{
    ...
    self.StarData = @[
    @{@"old":@"15",@"now":@"12",@"shop":@"Salabim意式餐厅(赤峰路店)",@"name":@"焦糖奶油布丁"},
    ...
    @{@"old":@"30",@"now":@"24",@"shop":@"权金城(杨浦总店)",@"name":@"烤五花肉"},
    @{@"old":@"38",@"now":@"30",@"shop":@"染山",@"name":@"三文鱼"},
    @{@"old":@"58",@"now":@"46",@"shop":@"沈家花园(控江店)",@"name":@"蟹粉豆腐"},
    ...
    @{@"old":@"88",@"now":@"70",@"shop":@"新南华(四平店)",@"name":@"水晶鸡"},
    @{@"old":@"42",@"now":@"34",@"shop":@"新雨花大酒店",@"name":@"卡夫牛排"},
    ];
